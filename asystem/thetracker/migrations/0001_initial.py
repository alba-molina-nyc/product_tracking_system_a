# Generated by Django 4.0.5 on 2022-07-12 20:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('setter_name', models.CharField(max_length=250)),
                ('setter_email', models.EmailField(max_length=400)),
                ('date_set', models.DateField(auto_now_add=True)),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='setters', to='thetracker.job')),
            ],
        ),
    ]
